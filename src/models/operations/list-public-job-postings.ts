...
export type ListPublicJobPostingsResponse = {
  headers: { [k: string]: Array<string> };
  result: models.ListPublicJobPostings200Envelope;
};
...
/** @internal */
export const ListPublicJobPostingsRequest$outboundSchema: z.ZodMiniType<
  ListPublicJobPostingsRequest$Outbound,
...
export function listPublicJobPostingsRequestToJSON(
  listPublicJobPostingsRequest: ListPublicJobPostingsRequest,
): string {
  return JSON.stringify(
    ListPublicJobPostingsRequest$outboundSchema.parse(
      listPublicJobPostingsRequest,
    ),
  );
}
...
/** @internal */
export const ListPublicJobPostingsResponse$inboundSchema: z.ZodMiniType<
  ListPublicJobPostingsResponse,
  unknown
> = z.pipe(
  z.object({
    Headers: z._default(z.record(z.string(), z.array(z.string())), {}),
    Result: models.ListPublicJobPostings200Envelope$inboundSchema,
  }),
  z.transform((v) => {
    return remap$(v, {
      "Headers": "headers",
...
export function listPublicJobPostingsResponseFromJSON(
  jsonString: string,
): SafeParseResult<ListPublicJobPostingsResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ListPublicJobPostingsResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ListPublicJobPostingsResponse' from JSON`,
  );
}
