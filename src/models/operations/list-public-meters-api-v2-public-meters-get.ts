...
export type ListPublicMetersApiV2PublicMetersGetRequest = {
...
export type ListPublicMetersApiV2PublicMetersGetResponse = {
  headers: { [k: string]: Array<string> };
  result: models.ListPublicMetersApiV2PublicMetersGet200Envelope;
};

/** @internal */
export type ListPublicMetersApiV2PublicMetersGetRequest$Outbound = {
...
/** @internal */
export const ListPublicMetersApiV2PublicMetersGetRequest$outboundSchema:
  z.ZodMiniType<
    ListPublicMetersApiV2PublicMetersGetRequest$Outbound,
...
export function listPublicMetersApiV2PublicMetersGetRequestToJSON(
  listPublicMetersApiV2PublicMetersGetRequest:
    ListPublicMetersApiV2PublicMetersGetRequest,
): string {
  return JSON.stringify(
    ListPublicMetersApiV2PublicMetersGetRequest$outboundSchema.parse(
      listPublicMetersApiV2PublicMetersGetRequest,
    ),
  );
}
...
/** @internal */
export const ListPublicMetersApiV2PublicMetersGetResponse$inboundSchema:
  z.ZodMiniType<ListPublicMetersApiV2PublicMetersGetResponse, unknown> = z.pipe(
    z.object({
      Headers: z._default(z.record(z.string(), z.array(z.string())), {}),
      Result:
        models.ListPublicMetersApiV2PublicMetersGet200Envelope$inboundSchema,
    }),
    z.transform((v) => {
      return remap$(v, {
        "Headers": "headers",
...
export function listPublicMetersApiV2PublicMetersGetResponseFromJSON(
  jsonString: string,
): SafeParseResult<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      ListPublicMetersApiV2PublicMetersGetResponse$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'ListPublicMetersApiV2PublicMetersGetResponse' from JSON`,
  );
}
