...
export type ListPublicInterviewsRequest = {
...
export type ListPublicInterviewsResponse = {
  headers: { [k: string]: Array<string> };
  result: models.ListPublicInterviews200Envelope;
};

/** @internal */
export type ListPublicInterviewsRequest$Outbound = {
...
/** @internal */
export const ListPublicInterviewsRequest$outboundSchema: z.ZodMiniType<
  ListPublicInterviewsRequest$Outbound,
...
export function listPublicInterviewsRequestToJSON(
  listPublicInterviewsRequest: ListPublicInterviewsRequest,
): string {
  return JSON.stringify(
    ListPublicInterviewsRequest$outboundSchema.parse(
      listPublicInterviewsRequest,
    ),
  );
}
...
/** @internal */
export const ListPublicInterviewsResponse$inboundSchema: z.ZodMiniType<
  ListPublicInterviewsResponse,
  unknown
> = z.pipe(
  z.object({
    Headers: z._default(z.record(z.string(), z.array(z.string())), {}),
    Result: models.ListPublicInterviews200Envelope$inboundSchema,
  }),
  z.transform((v) => {
    return remap$(v, {
      "Headers": "headers",
...
export function listPublicInterviewsResponseFromJSON(
  jsonString: string,
): SafeParseResult<ListPublicInterviewsResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ListPublicInterviewsResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ListPublicInterviewsResponse' from JSON`,
  );
}
