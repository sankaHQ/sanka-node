...
export type ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetRequest =
  {
...
export type ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetResponse =
  {
    headers: { [k: string]: Array<string> };
    result:
      models.ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGet200Envelope;
  };

/** @internal */
export type ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetRequest$Outbound =
  {
...
/** @internal */
export const ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetRequest$outboundSchema:
  z.ZodMiniType<
    ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetRequest$Outbound,
...
export function listPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetRequestToJSON(
  listPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetRequest:
    ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetRequest,
): string {
  return JSON.stringify(
    ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetRequest$outboundSchema
      .parse(
        listPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetRequest,
      ),
  );
...
/** @internal */
export const ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetResponse$inboundSchema:
  z.ZodMiniType<
  ...
  > = z.pipe(
    z.object({
      ...
      Result:
        models
          .ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGet200Envelope$inboundSchema,
    }),
    z.transform((v) => {
      return remap$(v, {
        "Headers": "headers",
...
export function listPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetResponseFromJSON(
  jsonString: string,
): SafeParseResult<
  ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetResponse,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetResponse$inboundSchema
        .parse(JSON.parse(x)),
    `Failed to parse 'ListPublicInventoryTransactionsApiV2PublicInventoryTransactionsGetResponse' from JSON`,
  );
}
