...
export type ListPublicInvoicesApiV2PublicInvoicesGetRequest = {
...
export type ListPublicInvoicesApiV2PublicInvoicesGetResponse = {
  headers: { [k: string]: Array<string> };
  result: models.ListPublicInvoicesApiV2PublicInvoicesGet200Envelope;
};

/** @internal */
export type ListPublicInvoicesApiV2PublicInvoicesGetRequest$Outbound = {
...
/** @internal */
export const ListPublicInvoicesApiV2PublicInvoicesGetRequest$outboundSchema:
  z.ZodMiniType<
    ListPublicInvoicesApiV2PublicInvoicesGetRequest$Outbound,
...
export function listPublicInvoicesApiV2PublicInvoicesGetRequestToJSON(
  listPublicInvoicesApiV2PublicInvoicesGetRequest:
    ListPublicInvoicesApiV2PublicInvoicesGetRequest,
): string {
  return JSON.stringify(
    ListPublicInvoicesApiV2PublicInvoicesGetRequest$outboundSchema.parse(
      listPublicInvoicesApiV2PublicInvoicesGetRequest,
    ),
  );
}
...
/** @internal */
export const ListPublicInvoicesApiV2PublicInvoicesGetResponse$inboundSchema:
  z.ZodMiniType<ListPublicInvoicesApiV2PublicInvoicesGetResponse, unknown> = z
    .pipe(
      z.object({
        Headers: z._default(z.record(z.string(), z.array(z.string())), {}),
        Result:
          models
            .ListPublicInvoicesApiV2PublicInvoicesGet200Envelope$inboundSchema,
      }),
      z.transform((v) => {
        return remap$(v, {
          "Headers": "headers",
...
export function listPublicInvoicesApiV2PublicInvoicesGetResponseFromJSON(
  jsonString: string,
): SafeParseResult<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      ListPublicInvoicesApiV2PublicInvoicesGetResponse$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'ListPublicInvoicesApiV2PublicInvoicesGetResponse' from JSON`,
  );
}
