...
export type ListPublicPaymentsApiV2PublicPaymentsGetRequest = {
...
export type ListPublicPaymentsApiV2PublicPaymentsGetResponse = {
  headers: { [k: string]: Array<string> };
  result: models.ListPublicPaymentsApiV2PublicPaymentsGet200Envelope;
};

/** @internal */
export type ListPublicPaymentsApiV2PublicPaymentsGetRequest$Outbound = {
...
/** @internal */
export const ListPublicPaymentsApiV2PublicPaymentsGetRequest$outboundSchema:
  z.ZodMiniType<
    ListPublicPaymentsApiV2PublicPaymentsGetRequest$Outbound,
...
export function listPublicPaymentsApiV2PublicPaymentsGetRequestToJSON(
  listPublicPaymentsApiV2PublicPaymentsGetRequest:
    ListPublicPaymentsApiV2PublicPaymentsGetRequest,
): string {
  return JSON.stringify(
    ListPublicPaymentsApiV2PublicPaymentsGetRequest$outboundSchema.parse(
      listPublicPaymentsApiV2PublicPaymentsGetRequest,
    ),
  );
}
...
/** @internal */
export const ListPublicPaymentsApiV2PublicPaymentsGetResponse$inboundSchema:
  z.ZodMiniType<ListPublicPaymentsApiV2PublicPaymentsGetResponse, unknown> = z
    .pipe(
      z.object({
        Headers: z._default(z.record(z.string(), z.array(z.string())), {}),
        Result:
          models
            .ListPublicPaymentsApiV2PublicPaymentsGet200Envelope$inboundSchema,
      }),
      z.transform((v) => {
        return remap$(v, {
          "Headers": "headers",
...
export function listPublicPaymentsApiV2PublicPaymentsGetResponseFromJSON(
  jsonString: string,
): SafeParseResult<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      ListPublicPaymentsApiV2PublicPaymentsGetResponse$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'ListPublicPaymentsApiV2PublicPaymentsGetResponse' from JSON`,
  );
}
