...
export type ListPublicEstimatesApiV2PublicEstimatesGetRequest = {
...
export type ListPublicEstimatesApiV2PublicEstimatesGetResponse = {
  headers: { [k: string]: Array<string> };
  result: models.ListPublicEstimatesApiV2PublicEstimatesGet200Envelope;
};

/** @internal */
export type ListPublicEstimatesApiV2PublicEstimatesGetRequest$Outbound = {
...
/** @internal */
export const ListPublicEstimatesApiV2PublicEstimatesGetRequest$outboundSchema:
  z.ZodMiniType<
    ListPublicEstimatesApiV2PublicEstimatesGetRequest$Outbound,
...
export function listPublicEstimatesApiV2PublicEstimatesGetRequestToJSON(
  listPublicEstimatesApiV2PublicEstimatesGetRequest:
    ListPublicEstimatesApiV2PublicEstimatesGetRequest,
): string {
  return JSON.stringify(
    ListPublicEstimatesApiV2PublicEstimatesGetRequest$outboundSchema.parse(
      listPublicEstimatesApiV2PublicEstimatesGetRequest,
    ),
  );
}
...
/** @internal */
export const ListPublicEstimatesApiV2PublicEstimatesGetResponse$inboundSchema:
  z.ZodMiniType<ListPublicEstimatesApiV2PublicEstimatesGetResponse, unknown> = z
    .pipe(
      z.object({
        Headers: z._default(z.record(z.string(), z.array(z.string())), {}),
        Result:
          models
            .ListPublicEstimatesApiV2PublicEstimatesGet200Envelope$inboundSchema,
      }),
      z.transform((v) => {
        return remap$(v, {
          "Headers": "headers",
...
export function listPublicEstimatesApiV2PublicEstimatesGetResponseFromJSON(
  jsonString: string,
): SafeParseResult<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      ListPublicEstimatesApiV2PublicEstimatesGetResponse$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'ListPublicEstimatesApiV2PublicEstimatesGetResponse' from JSON`,
  );
}
