...
export type ListPublicCompaniesApiV2PublicCompaniesGetRequest = {
...
export type ListPublicCompaniesApiV2PublicCompaniesGetResponse = {
  headers: { [k: string]: Array<string> };
  result: models.ListPublicCompaniesApiV2PublicCompaniesGet200Envelope;
};

/** @internal */
export type ListPublicCompaniesApiV2PublicCompaniesGetRequest$Outbound = {
...
/** @internal */
export const ListPublicCompaniesApiV2PublicCompaniesGetRequest$outboundSchema:
  z.ZodMiniType<
    ListPublicCompaniesApiV2PublicCompaniesGetRequest$Outbound,
...
export function listPublicCompaniesApiV2PublicCompaniesGetRequestToJSON(
  listPublicCompaniesApiV2PublicCompaniesGetRequest:
    ListPublicCompaniesApiV2PublicCompaniesGetRequest,
): string {
  return JSON.stringify(
    ListPublicCompaniesApiV2PublicCompaniesGetRequest$outboundSchema.parse(
      listPublicCompaniesApiV2PublicCompaniesGetRequest,
    ),
  );
}
...
/** @internal */
export const ListPublicCompaniesApiV2PublicCompaniesGetResponse$inboundSchema:
  z.ZodMiniType<ListPublicCompaniesApiV2PublicCompaniesGetResponse, unknown> = z
    .pipe(
      z.object({
        Headers: z._default(z.record(z.string(), z.array(z.string())), {}),
        Result:
          models
            .ListPublicCompaniesApiV2PublicCompaniesGet200Envelope$inboundSchema,
      }),
      z.transform((v) => {
        return remap$(v, {
          "Headers": "headers",
...
export function listPublicCompaniesApiV2PublicCompaniesGetResponseFromJSON(
  jsonString: string,
): SafeParseResult<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      ListPublicCompaniesApiV2PublicCompaniesGetResponse$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'ListPublicCompaniesApiV2PublicCompaniesGetResponse' from JSON`,
  );
}
