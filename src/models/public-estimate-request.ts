...
/** @internal */
export type PublicEstimateRequest$Outbound = {
...
/** @internal */
export const PublicEstimateRequest$outboundSchema: z.ZodMiniType<
  PublicEstimateRequest$Outbound,
...
export function publicEstimateRequestToJSON(
  publicEstimateRequest: PublicEstimateRequest,
): string {
  return JSON.stringify(
    PublicEstimateRequest$outboundSchema.parse(publicEstimateRequest),
  );
}
