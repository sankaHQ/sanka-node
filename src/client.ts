...
export interface ClientOptions {
   ...
   * Set the log level.
   *
   * Defaults to process.env['SANKA_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Sanka API.
 */
export class Sanka {
  apiKey: string | null;
   ...
   * API Client for interfacing with the Sanka API.
   *
   * @param {string | null | undefined} [opts.apiKey=process.env['SANKA_API_KEY'] ?? null]
   * @param {string} [opts.baseURL=process.env['SANKA_BASE_URL'] ?? https://api.sanka.com] - Override the default base URL for the API.
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Sanka.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('SANKA_LOG'), "process.env['SANKA_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.sanka.com';
  }
  ...
  static SankaError = Errors.SankaError;
...
export declare namespace Sanka {
