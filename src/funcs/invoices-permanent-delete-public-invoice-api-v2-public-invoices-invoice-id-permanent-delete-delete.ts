 ...
 */
export function invoicesPermanentDeletePublicInvoiceApiV2PublicInvoicesInvoiceIdPermanentDeleteDelete(
  client: SankaCore,
  request:
...
> {
  ...
  const path = pathToFunc("/v2/public/invoices/{invoice_id}/permanent-delete")(
    pathParams,
  );
