...
export function contactsCreate(
  ...
  Result<
    operations.CreatePublicContactApiV2PublicContactsPostResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CreatePublicContactApiV2PublicContactsPostRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "create_public_contact_api_v2_public_contacts_post",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations
        .CreatePublicContactApiV2PublicContactsPostResponse$inboundSchema,
