...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .ApiRoutersV1BillsPublicApiUpdatePublicBillRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "api_routers_v1_bills_public_api_update_public_bill",
    oAuth2Scopes: null,
  ...
  >(
    ...
    M.jsonErr([400, 403, 404, 409], errors.BillsErrorResponse$inboundSchema),
