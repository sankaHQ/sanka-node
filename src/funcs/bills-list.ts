...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations
            .ApiRoutersV1BillsPublicApiListWorkspaceBillsRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/v1/public/bills")();
  ...
  const context = {
    ...
    operationID: "api_routers_v1_bills_public_api_list_workspace_bills",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.BillSchema$inboundSchema)),
