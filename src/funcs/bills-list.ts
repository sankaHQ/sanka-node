...
export function billsList(
  ...
  Result<
    operations.ListPublicBillsApiV2PublicBillsGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.ListPublicBillsApiV2PublicBillsGetRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const context = {
    ...
    operationID: "list_public_bills_api_v2_public_bills_get",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.ListPublicBillsApiV2PublicBillsGetResponse$inboundSchema,
