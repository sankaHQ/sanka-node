 ...
 */
export function workforcePlanningSetPublicWorkforcePositionJob(
  client: SankaCore,
  request: operations.SetPublicWorkforcePositionJobRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SetPublicWorkforcePositionJobResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.SetPublicWorkforcePositionJobRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.SetPublicWorkforcePositionJobResponse$inboundSchema,
