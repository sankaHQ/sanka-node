...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .ApiRoutersV1InvoicesPublicApiGetPublicInvoiceRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "api_routers_v1_invoices_public_api_get_public_invoice",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.InvoiceSchema$inboundSchema),
