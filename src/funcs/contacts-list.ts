...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations
            .ApiRoutersV1ContactsPublicApiPublicListContactsRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const context = {
    ...
    operationID: "api_routers_v1_contacts_public_api_public_list_contacts",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ContactsListResponse$inboundSchema),
