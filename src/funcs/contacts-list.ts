...
export function contactsList(
  ...
  Result<
    operations.ListPublicContactsApiV2PublicContactsGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations
            .ListPublicContactsApiV2PublicContactsGetRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const context = {
    ...
    operationID: "list_public_contacts_api_v2_public_contacts_get",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.ListPublicContactsApiV2PublicContactsGetResponse$inboundSchema,
