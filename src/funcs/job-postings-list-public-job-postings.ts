 ...
 * List Records
 */
export function jobPostingsListPublicJobPostings(
  client: SankaCore,
  request?: operations.ListPublicJobPostingsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListPublicJobPostingsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListPublicJobPostingsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/job-postings")();
  ...
  const context = {
    ...
    operationID: "list_public_job_postings",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListPublicJobPostingsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
