...
export function workflowsGet(
  ...
  Result<
    models.PublicWorkflowDetailResponse,
...
> {
  ...
  const path = pathToFunc("/v1/public/workflows/{workflow_ref}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PublicWorkflowDetailResponse$inboundSchema),
