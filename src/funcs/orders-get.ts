...
export function ordersGet(
  ...
  Result<
    operations.GetPublicOrderApiV2PublicOrdersOrderIdGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .GetPublicOrderApiV2PublicOrdersOrderIdGetRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations
        .GetPublicOrderApiV2PublicOrdersOrderIdGetResponse$inboundSchema,
