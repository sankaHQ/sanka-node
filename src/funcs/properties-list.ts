...
export function propertiesList(
  ...
  Result<
    Array<models.PublicPropertySchema>,
...
> {
  ...
  const query = encodeFormQuery({
    "custom_only": payload.custom_only,
    "lang": payload.lang,
  ...
  const context = {
    ...
    operationID: "api_routers_v1_properties_public_api_list_public_properties",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.PublicPropertySchema$inboundSchema)),
    M.jsonErr(
      [400, 403, 404],
