...
export function metersCreate(
  ...
  Result<
    operations.CreatePublicMeterApiV2PublicMetersPostResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.CreatePublicMeterApiV2PublicMetersPostRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "create_public_meter_api_v2_public_meters_post",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.CreatePublicMeterApiV2PublicMetersPostResponse$inboundSchema,
