...
export function ticketsGet(
  ...
  Result<
    operations.GetPublicTicketApiV2PublicTicketsTicketIdGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .GetPublicTicketApiV2PublicTicketsTicketIdGetRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "get_public_ticket_api_v2_public_tickets__ticket_id__get",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations
        .GetPublicTicketApiV2PublicTicketsTicketIdGetResponse$inboundSchema,
