...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .ApiRoutersV1TicketsPublicApiGetPublicTicketRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "api_routers_v1_tickets_public_api_get_public_ticket",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TicketSchema$inboundSchema),
    M.jsonErr([400, 403, 404], errors.TicketsErrorResponse$inboundSchema),
