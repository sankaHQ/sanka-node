...
export function revenuesList(
  ...
  Result<
    operations.ListPublicSlipsApiV2PublicSlipsGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.ListPublicSlipsApiV2PublicSlipsGetRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const context = {
    ...
    operationID: "list_public_slips_api_v2_public_slips_get",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.ListPublicSlipsApiV2PublicSlipsGetResponse$inboundSchema,
