 ...
 * Get Workflow Run
 */
export function workflowsGetRun(
  client: SankaCore,
  request:
...
> {
  ...
  const path = pathToFunc("/v1/public/workflows/runs/{run_id}")(pathParams);
  ...
  >(
    ...
    M.jsonErr([403, 404], errors.WorkflowsErrorResponse$inboundSchema),
