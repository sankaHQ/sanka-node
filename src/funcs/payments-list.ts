...
export function paymentsList(
  ...
  Result<
    operations.ListPublicPaymentsApiV2PublicPaymentsGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations
            .ListPublicPaymentsApiV2PublicPaymentsGetRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/payments")();
  ...
  const context = {
    ...
    operationID: "list_public_payments_api_v2_public_payments_get",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.ListPublicPaymentsApiV2PublicPaymentsGetResponse$inboundSchema,
