 ...
 */
export function inventoryTransactionsCreate(
  client: SankaCore,
  request: models.PublicInventoryTransactionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.PublicInventoryTransactionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.PublicInventoryTransactionRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/public/inventory-transactions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PublicInventoryTransactionResponse$inboundSchema),
    M.jsonErr(
      [400, 403, 404],
