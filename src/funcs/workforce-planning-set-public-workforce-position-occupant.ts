 ...
 */
export function workforcePlanningSetPublicWorkforcePositionOccupant(
  client: SankaCore,
  request: operations.SetPublicWorkforcePositionOccupantRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SetPublicWorkforcePositionOccupantResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.SetPublicWorkforcePositionOccupantRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.SetPublicWorkforcePositionOccupantResponse$inboundSchema,
