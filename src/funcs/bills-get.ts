 ...
 * Get Public Bill
 */
export function billsGet(
  client: SankaCore,
  request: operations.GetPublicBillApiV2PublicBillsBillIdGetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetPublicBillApiV2PublicBillsBillIdGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetPublicBillApiV2PublicBillsBillIdGetRequest$outboundSchema,
        value,
      ),
  ...
  const pathParams = {
    bill_id: encodeSimple("bill_id", payload.bill_id, {
      explode: false,
  ...
  const context = {
    ...
    operationID: "get_public_bill_api_v2_public_bills__bill_id__get",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.GetPublicBillApiV2PublicBillsBillIdGetResponse$inboundSchema,
