...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.ScoreRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/score")();
  ...
  const context = {
    ...
    operationID: "api_routers_v1_ai_api_score_record",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ScoreResponse$inboundSchema),
    M.jsonErr([400, 401, 403, 404], errors.AIErrorResponse$inboundSchema),
    M.jsonErr(500, errors.AIErrorResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
