...
export function aiScore(
  ...
  Result<
    operations.ScoreRecordApiV2ScorePostResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.ScoreRecordApiV2ScorePostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v2/score")();
  ...
  const context = {
    ...
    operationID: "score_record_api_v2_score_post",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ScoreRecordApiV2ScorePostResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
