...
export function ticketsCreate(
  ...
  Result<
    operations.CreatePublicTicketApiV2PublicTicketsPostResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CreatePublicTicketApiV2PublicTicketsPostRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.CreatePublicTicketApiV2PublicTicketsPostResponse$inboundSchema,
