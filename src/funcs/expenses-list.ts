...
> {
  ...
  const path = pathToFunc("/v1/public/expenses")();
  ...
  const context = {
    ...
    operationID: "api_routers_v1_expenses_public_api_list_workspace_expenses",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.ExpenseSchema$inboundSchema)),
