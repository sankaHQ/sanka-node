 ...
 */
export function invoicesUploadPublicInvoiceFileApiV2PublicInvoicesFilesPost(
  client: SankaCore,
  request:
...
> {
  ...
  const path = pathToFunc("/v2/public/invoices/files")();
  ...
  const context = {
    ...
    operationID: "upload_public_invoice_file_api_v2_public_invoices_files_post",
    oAuth2Scopes: null,
