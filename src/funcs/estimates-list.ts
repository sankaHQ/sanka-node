...
export function estimatesList(
  ...
  Result<
    operations.ListPublicEstimatesApiV2PublicEstimatesGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations
            .ListPublicEstimatesApiV2PublicEstimatesGetRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const context = {
    ...
    operationID: "list_public_estimates_api_v2_public_estimates_get",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations
        .ListPublicEstimatesApiV2PublicEstimatesGetResponse$inboundSchema,
