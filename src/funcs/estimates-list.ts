...
> {
  ...
  const context = {
    ...
    operationID: "api_routers_v1_estimates_public_api_list_workspace_estimates",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.EstimateSchema$inboundSchema)),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
