 ...
 */
export function invoicesSendPublicInvoiceEmailApiV2PublicInvoicesInvoiceIdEmailPost(
  client: SankaCore,
  request:
...
> {
  ...
  const path = pathToFunc("/v2/public/invoices/{invoice_id}/email")(pathParams);
