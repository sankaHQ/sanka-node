...
export function journalsListPublicJournalsApiV2PublicJournalsGet(
  ...
  Result<
    operations.ListPublicJournalsApiV2PublicJournalsGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations
            .ListPublicJournalsApiV2PublicJournalsGetRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const context = {
    ...
    operationID: "list_public_journals_api_v2_public_journals_get",
    oAuth2Scopes: null,
