...
export function locationsCreate(
  ...
  Result<
    operations.CreatePublicLocationApiV2PublicLocationsPostResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CreatePublicLocationApiV2PublicLocationsPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/locations")();
  ...
  const context = {
    ...
    operationID: "create_public_location_api_v2_public_locations_post",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations
        .CreatePublicLocationApiV2PublicLocationsPostResponse$inboundSchema,
