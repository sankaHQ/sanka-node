 ...
 */
export function propertiesDelete(
  client: SankaCore,
  request:
...
> {
  ...
  const pathParams = {
    object_name: encodeSimple("object_name", payload.object_name, {
      explode: false,
      charEncoding: "percent",
    }),
    property_ref: encodeSimple("property_ref", payload.property_ref, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/v2/public/properties/{object_name}/{property_ref}")(
    pathParams,
  );
