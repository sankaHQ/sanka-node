 ...
 */
export function absencesListPublicAbsencesApiV2PublicAbsencesGet(
  client: SankaCore,
  request?:
  ...
  Result<
    operations.ListPublicAbsencesApiV2PublicAbsencesGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations
            .ListPublicAbsencesApiV2PublicAbsencesGetRequest$outboundSchema,
        ),
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.ListPublicAbsencesApiV2PublicAbsencesGetResponse$inboundSchema,
