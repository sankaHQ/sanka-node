...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .DeletePublicOrderApiV2PublicOrdersOrderIdDeleteRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/orders/{order_id}")(pathParams);
  ...
  const context = {
    ...
    operationID: "delete_public_order_api_v2_public_orders__order_id__delete",
    oAuth2Scopes: null,
