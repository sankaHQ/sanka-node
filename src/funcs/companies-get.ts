...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .ApiRoutersV1CompaniesPublicApiGetPublicCompanyRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "api_routers_v1_companies_public_api_get_public_company",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CompanySchema$inboundSchema),
