 ...
 */
export function workflowsCreateOrUpdate(
  client: SankaCore,
  request: operations.CreatePublicWorkflowApiV2PublicWorkflowsPostRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreatePublicWorkflowApiV2PublicWorkflowsPostResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CreatePublicWorkflowApiV2PublicWorkflowsPostRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "create_public_workflow_api_v2_public_workflows_post",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations
        .CreatePublicWorkflowApiV2PublicWorkflowsPostResponse$inboundSchema,
