...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.PublicWorkflowRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "api_routers_v1_workflows_public_api_create_public_workflow",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PublicWorkflowResponse$inboundSchema),
