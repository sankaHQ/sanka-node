 ...
 */
export function workflowsListActions(
  client: SankaCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.PublicWorkflowActionsResponse,
...
> {
  const path = pathToFunc("/v1/public/workflows/actions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PublicWorkflowActionsResponse$inboundSchema),
    M.jsonErr(403, errors.WorkflowsErrorResponse$inboundSchema),
