 ...
 * Delete Subscription
 */
export function subscriptionsDelete(
  client: SankaCore,
  request:
  ...
  Result<
    models.PublicSubscriptionDeleteResponse,
...
> {
  ...
  const path = pathToFunc("/v1/public/subscriptions/{subscription_id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PublicSubscriptionDeleteResponse$inboundSchema),
    M.jsonErr(
      [400, 403, 404, 409],
      errors.SubscriptionErrorResponse$inboundSchema,
    ),
