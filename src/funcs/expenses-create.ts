...
export function expensesCreate(
  ...
  Result<
    operations.CreatePublicExpenseApiV2PublicExpensesPostResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CreatePublicExpenseApiV2PublicExpensesPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/expenses")();
  ...
  const context = {
    ...
    operationID: "create_public_expense_api_v2_public_expenses_post",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations
        .CreatePublicExpenseApiV2PublicExpensesPostResponse$inboundSchema,
