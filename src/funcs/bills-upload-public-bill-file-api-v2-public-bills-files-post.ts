 ...
 */
export function billsUploadPublicBillFileApiV2PublicBillsFilesPost(
  client: SankaCore,
  request: operations.UploadPublicBillFileApiV2PublicBillsFilesPostRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UploadPublicBillFileApiV2PublicBillsFilesPostResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .UploadPublicBillFileApiV2PublicBillsFilesPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/bills/files")();
  ...
  const context = {
    ...
    operationID: "upload_public_bill_file_api_v2_public_bills_files_post",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations
        .UploadPublicBillFileApiV2PublicBillsFilesPostResponse$inboundSchema,
