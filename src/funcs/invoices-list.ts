...
export function invoicesList(
  ...
  Result<
    operations.ListPublicInvoicesApiV2PublicInvoicesGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations
            .ListPublicInvoicesApiV2PublicInvoicesGetRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/invoices")();
  ...
  const context = {
    ...
    operationID: "list_public_invoices_api_v2_public_invoices_get",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.ListPublicInvoicesApiV2PublicInvoicesGetResponse$inboundSchema,
