 ...
 * List Records
 */
export function applicantsListPublicApplicants(
  client: SankaCore,
  request?: operations.ListPublicApplicantsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListPublicApplicantsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListPublicApplicantsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/applicants")();
  ...
  const context = {
    ...
    operationID: "list_public_applicants",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListPublicApplicantsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
