...
export function reportsCreate(
  ...
  Result<
    operations.CreatePublicReportApiV2PublicReportsPostResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CreatePublicReportApiV2PublicReportsPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/reports")();
  ...
  const context = {
    ...
    operationID: "create_public_report_api_v2_public_reports_post",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.CreatePublicReportApiV2PublicReportsPostResponse$inboundSchema,
