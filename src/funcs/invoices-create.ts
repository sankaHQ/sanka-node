...
export function invoicesCreate(
  ...
  Result<
    operations.CreatePublicInvoiceApiV2PublicInvoicesPostResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CreatePublicInvoiceApiV2PublicInvoicesPostRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "create_public_invoice_api_v2_public_invoices_post",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations
        .CreatePublicInvoiceApiV2PublicInvoicesPostResponse$inboundSchema,
