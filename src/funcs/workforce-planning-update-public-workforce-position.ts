 ...
 */
export function workforcePlanningUpdatePublicWorkforcePosition(
  client: SankaCore,
  request: operations.UpdatePublicWorkforcePositionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdatePublicWorkforcePositionResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdatePublicWorkforcePositionRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations.UpdatePublicWorkforcePositionResponse$inboundSchema,
