...
export function dealsList(
  ...
  Result<
    operations.ListPublicDealsApiV2PublicDealsGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.ListPublicDealsApiV2PublicDealsGetRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const context = {
    ...
    operationID: "list_public_deals_api_v2_public_deals_get",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.ListPublicDealsApiV2PublicDealsGetResponse$inboundSchema,
