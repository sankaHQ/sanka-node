...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .ApiRoutersV1PaymentsPublicApiGetPublicPaymentRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "api_routers_v1_payments_public_api_get_public_payment",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ReceiptSchema$inboundSchema),
    M.jsonErr([400, 403, 404], errors.PaymentsErrorResponse$inboundSchema),
