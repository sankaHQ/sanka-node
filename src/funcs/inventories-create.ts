...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CreatePublicInventoryApiV2PublicInventoriesPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/inventories")();
  ...
  const context = {
    ...
    operationID: "create_public_inventory_api_v2_public_inventories_post",
    oAuth2Scopes: null,
