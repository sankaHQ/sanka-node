 ...
 * List Records
 */
export function interviewsListPublicInterviews(
  client: SankaCore,
  request?: operations.ListPublicInterviewsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListPublicInterviewsResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.ListPublicInterviewsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/interviews")();
  ...
  const context = {
    ...
    operationID: "list_public_interviews",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListPublicInterviewsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
