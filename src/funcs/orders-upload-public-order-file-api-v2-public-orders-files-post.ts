 ...
 */
export function ordersUploadPublicOrderFileApiV2PublicOrdersFilesPost(
  client: SankaCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .UploadPublicOrderFileApiV2PublicOrdersFilesPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/orders/files")();
  ...
  const context = {
    ...
    operationID: "upload_public_order_file_api_v2_public_orders_files_post",
    oAuth2Scopes: null,
