...
export function locationsList(
  ...
  Result<
    operations.ListPublicLocationsApiV2PublicLocationsGetResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations
            .ListPublicLocationsApiV2PublicLocationsGetRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const context = {
    ...
    operationID: "list_public_locations_api_v2_public_locations_get",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations
        .ListPublicLocationsApiV2PublicLocationsGetResponse$inboundSchema,
