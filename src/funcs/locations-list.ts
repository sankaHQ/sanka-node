...
export function locationsList(
  ...
  Result<
    Array<models.InventoryWarehouseSchema>,
    | SankaError
...
> {
  ...
  const context = {
    ...
    operationID: "api_routers_v1_locations_public_api_list_workspace_locations",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.InventoryWarehouseSchema$inboundSchema)),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
