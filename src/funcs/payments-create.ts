...
export function paymentsCreate(
  ...
  Result<
    operations.CreatePublicPaymentApiV2PublicPaymentsPostResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .CreatePublicPaymentApiV2PublicPaymentsPostRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "create_public_payment_api_v2_public_payments_post",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations
        .CreatePublicPaymentApiV2PublicPaymentsPostResponse$inboundSchema,
