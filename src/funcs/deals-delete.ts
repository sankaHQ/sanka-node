 ...
 * Delete Public Deal
 */
export function dealsDelete(
  client: SankaCore,
  request: operations.DeletePublicDealApiV2PublicDealsDealIdDeleteRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeletePublicDealApiV2PublicDealsDealIdDeleteResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .DeletePublicDealApiV2PublicDealsDealIdDeleteRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "delete_public_deal_api_v2_public_deals__deal_id__delete",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations
        .DeletePublicDealApiV2PublicDealsDealIdDeleteResponse$inboundSchema,
