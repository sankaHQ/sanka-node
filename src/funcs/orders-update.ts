...
export function ordersUpdate(
  ...
  Result<
    operations.UpdatePublicOrderApiV2PublicOrdersOrderIdPutResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .UpdatePublicOrderApiV2PublicOrdersOrderIdPutRequest$outboundSchema,
        value,
      ),
  ...
  >(
    M.json(
      200,
      operations
        .UpdatePublicOrderApiV2PublicOrdersOrderIdPutResponse$inboundSchema,
