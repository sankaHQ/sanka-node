...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .BulkCreatePublicOrdersApiV2PublicOrdersBulkPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v2/public/orders/bulk")();
  ...
  const context = {
    ...
    operationID: "bulk_create_public_orders_api_v2_public_orders_bulk_post",
    oAuth2Scopes: null,
