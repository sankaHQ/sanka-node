...
| `mappingCustomFieldsConditional` | Record<string, *any*>            | :heavy_minus_sign:               | N/A                              |
| `updateHubspot`                  | *any*                            | :heavy_minus_sign:               | N/A                              |
| `hubspotFollowUpChannelId`       | *string*                         | :heavy_minus_sign:               | N/A                              |
| `hubspotFollowUpDealStage`       | *string*                         | :heavy_minus_sign:               | N/A                              |
