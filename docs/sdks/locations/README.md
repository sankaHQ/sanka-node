...
import { locationsList } from "sanka-sdk/funcs/locations-list.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("locationsList failed:", res.error);
  }
}
...
```typescript
import { SankaCore } from "sanka-sdk/core.js";
import { locationsCreate } from "sanka-sdk/funcs/locations-create.js";
...
async function run() {
  const result = await sanka.locations.get({
    locationId: "<id>",
  });
...
```typescript
import { SankaCore } from "sanka-sdk/core.js";
import { locationsGet } from "sanka-sdk/funcs/locations-get.js";
...
async function run() {
  const res = await locationsGet(sanka, {
    locationId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await sanka.locations.update({
    locationId: "<id>",
    body: {},
  });
...
```typescript
import { SankaCore } from "sanka-sdk/core.js";
import { locationsUpdate } from "sanka-sdk/funcs/locations-update.js";
...
async function run() {
  const res = await locationsUpdate(sanka, {
    locationId: "<id>",
    body: {},
  });
  if (res.ok) {
...
async function run() {
  const result = await sanka.locations.delete({
    locationId: "<id>",
  });
...
```typescript
import { SankaCore } from "sanka-sdk/core.js";
import { locationsDelete } from "sanka-sdk/funcs/locations-delete.js";
...
async function run() {
  const res = await locationsDelete(sanka, {
    locationId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("locationsDelete failed:", res.error);
  }
}
